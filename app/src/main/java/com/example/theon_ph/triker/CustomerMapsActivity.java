    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomerMapsActivity.this, ChoiceActivity.class);
        ...
        mRequest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (requestBol){
                    ...
                    mRequest.setText("Getting your tricycle");
        ...
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyEntered(String key, GeoLocation location) {
                if (!driverFound && requestBol)
                {
                    ...
                    map.put("customerRideId", customersId);
                    ...
                    getDriverInfo();
                    getHasRideEnded();
                    mRequest.setText("Looking for Tricycle location...");
        ...
        driverLocationRefListener = driverLocationRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists() && requestBol){
                    ...
                    mDriverMarker = mMap.addMarker(new MarkerOptions().position(driverLatLng).title("your driver").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_marker )));
                }
            }
